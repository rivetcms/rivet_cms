  ...
  return (
    <>
      ...
      >
        ...
        <Link href={contentType.paths.documents} className="btn btn-ghost gap-1.5 border border-base-300 bg-base-100">
          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9z"/><path d="M15 3v6h6"/></svg>
          Entries
        </Link>
      ...
      <div className="rounded-box border border-base-300 bg-base-100">
        ...
        <div className="p-4">
          {fields.length > 0 ? (
            <FieldsBuilder owner={contentType} fields={fields} onEdit={openEdit} />
          ) : (
      ...
      <SettingsModal open={settingsOpen} title={`${contentType.name} settings`} onClose={() => setSettingsOpen(false)}>
        <ContentTypeForm
