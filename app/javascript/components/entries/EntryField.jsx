...
function ComponentField({ field, value, onChange, referenceOptions }) {
...
function ReferenceInput({ field, value, onChange, options }) {
...
export default function EntryField({ field, value, onChange, referenceOptions }) {
  const common = { label: field.label, hint: field.description, required: field.required }
  ...
  switch (field.field_type) {
    ...
    case "integer":
      return <TextInput {...common} type="number" value={value ?? ""} onChange={(e) => onChange(e.target.value === "" ? null : Number(e.target.value))} />
    case "date":
    ...
    case "reference":
      return <ReferenceInput field={field} value={value} onChange={onChange} options={referenceOptions} />
    case "image":
    case "video":
    case "file":
      return <MediaField field={field} value={value} onChange={onChange} />
    case "component":
      return <ComponentField field={field} value={value} onChange={onChange} referenceOptions={referenceOptions} />
    default:
      return null
  }
}
